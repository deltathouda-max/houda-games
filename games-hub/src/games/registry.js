...
export const GAMES = [
  ...
  },
  {
    ...
    component: JuunanaHo,
    available: true,
    rules: '麻雀牌34種類(各1枚ずつ)から13枚を選び、あと1枚であがれば満貫以上(4翻以上)になる「テンパイ」の形を作ります。\n残り21枚が自分の捨て牌候補になり、交互に1枚ずつ切っていきます。\n相手の捨て牌が自分のあがり牌で、満貫以上の役が付くなら「ロン」で勝ち。役が足りない場合や見逃した場合は、そのハンドの間ロンできなくなります(フリテン)。\n17巡で決着しなければ流局です。\nドラ表示牌もあり、ドラは翻数に加算されます。\n※このルールでは同じ牌を2枚以上持てないため刻子・七対子は作れず、実現できる役はタンヤオ・一気通貫・三色同順・チャンタ/ジュンチャンに絞られる簡易ルールです。\n毎ハンドでチップを賭け、チップがなくなったら負けです。',
  },
]
